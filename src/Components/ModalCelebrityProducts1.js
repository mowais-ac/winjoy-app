...
const ModalCelebrityProducts1 = (props) => {
    ...
    <TouchableWithoutFeedback
      ...
      <View style={styles.ModalView}>
       ...
       <Text style={[styles.text, { textAlign: 'center', marginTop: height * 0.03, width: width * 0.8 }]}>
        ...
        <Video
              source={{uri:"https://winjoy-assets.s3.amazonaws.com/banners/banner-3.mp4"}}  
              resizeMode={"cover"}
              minLoadRetryCount={1}
              fullScreen={true}
...
export default ModalCelebrityProducts1;
