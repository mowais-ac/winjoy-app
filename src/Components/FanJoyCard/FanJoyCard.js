  ...
  return (
    ...
    >
      <View >
        ...
        >
          <Text style={{color:'#ffffff',fontFamily:'Axiforma SemiBold',fontSize: 10}}>{name}</Text>
          <Text style={{color:'#ffffff',fontFamily:'Axiforma Regular',fontSize: 8.5}}>{fans}Fans</Text>
        </LinearGradient>
      </View>
    </TouchableOpacity>
  );
