...
import { GameShowWinnersCard, LifeCard, LifeCardRefferAndVideo, TopTab, WjBackground } from "../../Components";
        ...
        >
              ...
              <FlatList
                ...
                renderItem={({ item, index }) => (
                  <View style={index === 1 ? styles.avatarView : styles.leftRightavatarView}>
                    ...
                    />
                    <View style={{
                      position: 'absolute', width: width * 0.3,
                      height: width * 0.3,top:-10, left: 1
                    }}>
                      <Image
                        source={index === 1 ? crown : redStar}
                        style={index === 1 ? styles.topListIcon2 : styles.topListIcon}
                      />
                    </View>
          ...
          <View style={{ width: '100%', alignItems: 'center', marginTop: height*0.16 }}>
            <FlatList
              ...
              // horizontal={true}
              ItemSeparatorComponent={() => (
                <View style={{ backgroundColor: "rgba(255, 255, 255, 0.5)", height: 1,width:width }} />
              )}
              renderItem={
                ({ item, index }) => {
                  return (
