...
const index = ({route, navigation}:any) => {
  const leaderBoardWinners = useSelector(state => state.leaderboardwinners.leaderboardwinnersData);
        ...
        <ScrollView
          ...
          <View
            ...
            <View style={{width: width, height: height * 0.28}}>
              {leaderBoardWinners?.loading ? (
                <ActivityIndicator size="large" color="#fff" />
              ) : (
                <FlatList
                  horizontal={true}
                  style={{marginLeft: 1, width: width}}
                  data={leaderBoardWinners?.data?.leaders?.slice(0, 3)}
          ...
          <View
            ...
            {leaderBoardWinners?.loading ? (
              ...
              <FlatList
                data={leaderBoardWinners?.data?.leaders?.slice(3)}
                // horizontal={true}
