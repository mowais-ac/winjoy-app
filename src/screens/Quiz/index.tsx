...
import { gameshowwinnersData } from '../../reduxToolkit/actions/gameshowwinners.actions';
const {width, height} = Dimensions.get('window');
let timer = () => {};
const BackgroundVideo = ({route, navigation}:any) => {
  ...
  const enter_gameshow = async () => {
    ...
    await fetch(`${apiBaseUrl}/joinGameshow`, requestOptions)
  ...
  const Questions = async () => {
    ...
    await axios
      .get(
        `${apiBaseUrl}/begin/game/questions/answers/list`,
        requestOptions,
      )
      .then(response => {
  ...
  const DeductLive = useCallback(async () => {
    ...
    await fetch(
      `${apiBaseUrl}/deduct_lives/${questionRef.current[activeQuestion]?.live_gameshow_id}`,
      requestOptions,
    )
      .then(async response => response.json())
      .then(async res => {
  ...
  const SaveResponse = useCallback(async activeQ => {
    ...
    if (answerId.current === undefined) {
      ...
      await fetch(`${apiBaseUrl}/save/user/response`, requestOptions)
        .then(async response => response.json())
        .then(async res => {
          /*  {
