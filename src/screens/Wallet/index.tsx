...
import TopupPaymentModals from '../../Components/TopupPaymentModals';
 ...
 const wallet = useSelector(state => state?.wallet?.walletData);
  ...
  const HandleWithdraw = async accountId => {
    ...
    if (!activeno) {
      ...
      await fetch(`${apiBaseUrl}/withdrawal`, requestOptions)
    ...
    <SafeAreaView style={{backgroundColor: '#420E92'}}>
      <ScrollView
        ...
        <WalletLastPlayedCard
          ...
          noOfQuestions={10}
          wonPrize={
            wallet?.data?.wallet?.won_prize === null
              ? 0
              : wallet?.data?.wallet?.won_prize
          }
        />
