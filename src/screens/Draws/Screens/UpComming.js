...
const UpComming = ({props, navigation}) => {
  ...
  return (
    <ScrollView style={{backgroundColor: '#ffffff'}}>
      <LinearGradient colors={['#420E92', '#E7003F']} style={styles.mainView}>
        <Text style={styles.heading}>Daily Challenge & Win</Text>
        <Label
          primary
          font={16}
          bold
          ...
          Answer 12 simple questions and{' '}
          <Label primary font={16} bold dark style={{color: 'yellow'}}>
            WIN
          </Label>
        ...
        <LinearGradient
          ...
          <Label primary font={16} dark style={{color: '#420E92'}}>
            {dayjs(livegameData?.LivegameShow?.start_date).format(
