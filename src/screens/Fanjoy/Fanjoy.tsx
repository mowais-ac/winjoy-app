...
import {fanjoyData} from '../../reduxToolkit/actions/fanjoy.actions';
import { causesSlugData } from '../../reduxToolkit/actions/causesSlug.actions';
const {width, height} = Dimensions.get('window');

const Fanjoy = ({navigation}: any) => {
