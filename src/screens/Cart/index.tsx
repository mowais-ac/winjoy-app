...
import { cartData } from '../../reduxToolkit/actions/cart.actions';
import { CART_COUNTER } from '../../reduxToolkit/slices/userSlice';
const index = ({navigation}:any) => {
 // const defaultAppAnalytics = firebase.analytics();
  ...
  const counterMain = useSelector(state => state?.cart?.cartCounter);
 ...
 // const counterMain = useSelector(state => state.app.counter);
  ...
  const RemoveItem = (id, qty) => {
    ...
    dispatch3(CART_COUNTER(counterMain - qty));
  };
    ...
    <SafeAreaView
      ...
      <View style={{backgroundColor: '#f6f1f3'}}>
                ...
                <View style={styles.card2}>
                  <View
                    ...
                    <Text
                      ...
                      {'AED '}
                      {FormatNumber(+cartList?.data?.sub_total)}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text style={styles.text}>
                      {'AED '}
                      {FormatNumber(Math.trunc(cartList?.data?.total))}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text style={styles.text}>
                      {'AED '}
                      {FormatNumber(Math.trunc(cartList?.data?.vat))}
                    </Text>
                  </View>
                  <TouchableOpacity
                    onPress={() => {
        ...
        <PaymentModals
          ModalRef={ModalState}
          details
          total={cartList?.data?.sub_total}
          onload={() => {
            onRefresh();
          }}
          yourBalance={
            wallet?.data?.wallet?.your_balance === null
              ? 0
              : wallet?.data?.wallet?.your_balance
          }
        />
        <Modals
