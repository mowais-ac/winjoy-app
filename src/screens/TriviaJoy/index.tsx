...
import { triviajoyallData } from '../../reduxToolkit/actions/triviajoy.actions';
import { joingameshowData } from '../../reduxToolkit/actions/joinGameshow.actions';
const MYServer = 'https://node-winjoyserver-deploy.herokuapp.com/';
const index = ({navigation}:any) => {
  const LandingData = useSelector(state => state?.home?.homeData);
  const triviaJoyData = useSelector(state => state?.triviajoyall?.triviajoyallData);
