...
const index = ({route, navigation}:any) => {
  ...
  useEffect(() => {
    ...
    let li = [];
    let idforFirst;
    livePlans?.data?.plan?.forEach(element => {
  ...
  const PostData = async postData => {
    ...
    await fetch(`${apiBaseUrl}/buy_lives_plan/${id}`, requestOptions)
            ...
            <View
              ...
              <ImageBackground
                ...
                <Text
                  ...
                  {livePlans?.data?.total_lives === null ? 0 : livePlans?.data?.total_lives}
                </Text>
              </ImageBackground>
