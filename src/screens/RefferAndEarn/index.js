                ...
                >
                    ...
                    <View style={{ width: '100%', alignItems: 'center', marginTop: height * 0.055 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '90%', }}>
                            ...
                            <ImageBackground
                                resizeMode="center"
                                style={{ width: 100, height: 90, marginTop: 10, justifyContent: 'center', alignItems: 'center' }}
                        ...
                        <View style={{ width: width * 0.15, height: 2, backgroundColor: '#ffffff' }} />


                        <View style={{ marginTop: height * 0.03, width: width, flexDirection: 'row', justifyContent: 'space-between' }}>
